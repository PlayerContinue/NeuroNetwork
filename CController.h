...
private:
	...
	//Storage vector containing positions of things which are not mines
	vector<SVector2D>	   m_vecNotMines;
	...
	//vertex buffer for the not mine shape's vertices
	vector<SPoint>		   m_NotMineVB;
