...
public:
  ...
  //scaling factor for mines
  static double dNotMineScale;

  //---------------------------------------GA parameters
  static double dCrossoverRate;
  static double dMutationRate;
  static double dUniformCrossoverRate;
  static int CrossoverType;
  static int dSelectionType;
  static int dTournamentNumber;
  ...
  CParams()
  {
    if(!LoadInParameters("params.ini") && !LoadInParameters("../params.ini"))
    {
