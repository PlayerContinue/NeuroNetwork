...
int CParams::iNumNotMines			= 0;
int CParams::iNumTicks              = 0;
double CParams::dMineScale          = 0;
double CParams::dNotMineScale = 0;
...
double CParams::dUniformCrossoverRate = 0;
int CParams::CrossoverType = 0;
int CParams::dSelectionType = 0;
int CParams::dTournamentNumber = 5;
...
bool CParams::LoadInParameters(char* szFileName)
{
  ...
  grab >> ParamDescription;
  grab >> dUniformCrossoverRate;
  grab >> ParamDescription;
  grab >> CrossoverType;
  grab >> ParamDescription;
  grab >> dSelectionType;
  grab >> ParamDescription;
  grab >> dTournamentNumber;
